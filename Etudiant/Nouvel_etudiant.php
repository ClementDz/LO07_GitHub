            ...
            <form method='POST' action="Anciens_cours.php">
                <fieldset>
                    ...
                    <p>
                        ...
                        <input type="radio" name="admi" value="TC" required/>TC
                        <input type="radio" name="admi" value="Branche" required>Branche

                    </p>
                    <p>
                        <label>Votre filière actuelle</label>
                        <input type="radio" name="filiere" value="TC" required onclick="affichepas()"/>TC
                        <input type="radio" name="filiere" value="TCBR" required onclick="affichepas()"/>TCBR
                        <input type="radio" name="filiere" value="FI" required onclick="affiche();"/>Filière
